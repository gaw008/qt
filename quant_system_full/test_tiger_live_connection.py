...
def test_tiger_connection():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ Quote permissions test failed: {e}")

        # Test trade client
        print("\n💼 Testing Trade Client...")
        try:
        ...
        try:
            ...
            print(f"⚠️ Positions test failed: {e}")
        ...
        try:
            ...
            if balance:
                ...
                if available_cash:
                    ...
                    print(f"   💰 Balance object found but no available_cash field")
            else:
                print("⚠️ No balance information available")

        except Exception as e:
            print(f"⚠️ Balance test failed: {e}")
